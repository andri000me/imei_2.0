...
<body style="background-color: #012140;">
    ...
    <div class="container border rounded" style="background-color: #ffffff;padding-top: 10px;padding-bottom: 10px;margin-top: 20px;margin-bottom: 20px;">
        ...
        <p style="font-size: 14px;letter-spacing: 1px;">The table below show all your reports on your lost devices.</p>
        <div class="row" style="padding: 15px;">
            <div class="col">
                <h5 class="text-monospace text-center text-info" style="letter-spacing: 1px;font-weight: bold;">My Reports</h5>
                <div class="border rounded shadow-sm" style="padding: 5px;">
                    <div class="table-responsive-md text-monospace" style="font-size: 14px;letter-spacing: 1px;">
                        ...
                        <?php
                        //
                        $sql="select * from reports where user = '$user' order by date_reported desc;";
                      ...
                      while($row=mysqli_fetch_assoc($query))
                            ...
                            <tbody>
                                <tr class="text-center">
                                    ...
                                    <td style="font-size:12px;"><?php echo $row["date_reported"];  ?></td>
                                    <td>
                                        <div class="btn-group btn-group-sm" role="group"><a class="btn btn-danger active text-monospace" role="button" style="font-size: 12px;letter-spacing: 1px;font-weight: bold;" href="delete.php?rdelete=<?php echo $row["report_id"];  ?>">Delete</a></div>
                                    </td>
                                </tr>
                            </tbody>
                            <?php

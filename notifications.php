...
<body style="background-color: #012140;">
    ...
    <div class="container border rounded" style="background-color: #ffffff;padding-top: 10px;padding-bottom: 10px;margin-top: 20px;margin-bottom: 20px;">
        ...
        <p style="font-size: 14px;letter-spacing: 1px;">The table below shows notifications received.</p>
        <div class="row" style="padding: 15px;">
            <div class="col">
                <h5 class="text-monospace text-center text-info" style="letter-spacing: 1px;font-weight: bold;">My Notifications</h5>
                <div class="border rounded shadow-sm" style="padding: 5px;">
                    <div class="table-responsive-md text-monospace" style="font-size: 14px;letter-spacing: 1px;">
                        <?php
                        //
                    $query="select * from notifications where reporter_id = '$user' order by date_added desc;";
                    $result=mysqli_query($connect,$query) or die (mysqli_error($connect));
                        //
                        ?>
                        <table class="table table-sm">
                            <thead>
                                <tr class="text-monospace text-center">
                                    <th>Date Received</th>
                                    <th>Content</th>
                                </tr>
                            </thead>
                            ...
                            <tbody>
                                <tr class="text-center">
                                    <td><?php echo $rowq["date_added"]; ?></td>
                                    <td><?php echo $rowq["notification"]; ?></td>
                                    <td>
                                        <div class="btn-group btn-group-sm" role="group"><a class="btn btn-danger active text-monospace" role="button" style="font-size: 12px;letter-spacing: 1px;font-weight: bold;" href="delete.php?not_lete=<?php echo $rowq["notification_id"];  ?>">Delete</a></div>
                                    </td>
                                </tr>
                            </tbody>
                            <?php
                    ...
                    <div class="row" style="margin-bottom: 10px;">
                        ...
                        <div class="col-md-6">
                            <div class="border rounded shadow-sm" style="padding: 10px;">
                                <div class="text-center text-muted"><i class="far fa-envelope-open" style="font-size: 25px;"></i></div>
                                <p class="text-monospace text-center text-muted" style="margin-bottom: 5px;font-size: 14px;letter-spacing: 1px;">Inbox Empty</p>
                            </div>
                        </div>
                        <div class="col-md-3"></div>
                    </div>
